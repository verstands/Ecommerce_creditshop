  ...
  return (
    <div className="flex h-[calc(100vh-80px)] items-center justify-center p-5 w-full bg-white">
      <div className="text-center">
        ...
        <h1 className="mt-5 text-3xl font-bold text-gray-800 lg:text-4xl">500 - Erreur serveur</h1>
        <p className="text-gray-600 mt-5 text-lg">Oups, une erreur s'est produite. Essayez de rafraîchir cette page ou <br /> n'hésitez pas à nous contacter si le problème persiste.</p>
      </div>
    </div>
  );
};

export default Connexioin500;